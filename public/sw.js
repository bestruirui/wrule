const SHELL_CACHE = "wrule-shell-v1";
const RUNTIME_CACHE = "wrule-runtime-v1";
const CORE_ASSETS = [
...
self.addEventListener("activate", (event) => {
	event.waitUntil((async () => {
		...
		await Promise.all(
			cacheNames
				.filter((cacheName) => cacheName.startsWith("wrule-") && cacheName !== SHELL_CACHE && cacheName !== RUNTIME_CACHE)
